...
export default function PurchasePayment() {
  ...
  const dummyPay = [
    { id: 1, date: '21 Sep 2026', payNo: 'PP-202609-001', vendor: 'CV. Komputer Jaya', method: 'Transfer Bank', amount: 'Rp 14.500.000', status: 'Berhasil' },
    { id: 2, date: '28 Sep 2026', payNo: 'PP-202609-002', vendor: 'PT. Plastikindo', method: 'Giro', amount: 'Rp 10.000.000', status: 'Pending' },
  ];
        ...
        <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Cari no. bayar atau vendor..." 
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-slate-700 dark:text-slate-300">
              {dummyPay.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                  ...
                  <td className="px-6 py-4 text-slate-500 dark:text-slate-400">{item.method}</td>
