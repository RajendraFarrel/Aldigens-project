...
import { Search, Plus, Filter, MoreVertical, PackagePlus } from 'lucide-react';

export default function ReceiveItem() {
  const [searchTerm, setSearchTerm] = useState('');

  const dummyReceive = [
    { id: 1, date: '26 Sep 2026', riNo: 'RI-202609-001', vendor: 'PT. Plastikindo', refPO: 'PO-202609-012', status: 'Diterima Penuh' },
    { id: 2, date: '25 Sep 2026', riNo: 'RI-202609-002', vendor: 'CV. Komputer Jaya', refPO: 'PO-202609-010', status: 'Diterima Sebagian' },
    { id: 3, date: '22 Sep 2026', riNo: 'RI-202609-003', vendor: 'Toko ATK Makmur', refPO: 'PO-202609-005', status: 'Diterima Penuh' },
  ];
        ...
        <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Cari no. RI atau vendor..." 
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-slate-50 dark:bg-slate-950/50 text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800">
              <tr>
                ...
                <th className="px-6 py-4 font-medium">No. Penerimaan</th>
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-slate-700 dark:text-slate-300">
              {dummyReceive.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                  ...
                  <td className="px-6 py-4 text-slate-500 dark:text-slate-400">{item.refPO}</td>
